...
<td> ';if($row['availability']=='Available'){echo '<form class="form-horizontal" action="Notava.php" method="post"><div class="col-sm-offset-2 col-sm-10">
...
else{ echo '<form class="form-horizontal" action="ava.php" method="post"><div class="col-sm-offset-2 col-sm-10">
