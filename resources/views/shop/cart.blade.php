...
@section('content')
    ...
    <div class="container">
            ...
            <div class="col-sm-9">
                <div class=" container" style="box-shadow: 0px 0px 3px rgba(0,0,0,0.3); max-width: 800px; min-width: 500px; position: relative; top: -10px; padding: 30px; border-radius: 5px">
                    <div class="row">
