                        ...
                        <div class="row" style="margin-top: 15px">
                            ...
                            <div class="col-md-2 col-xs-3">
                                ...
                                <a href="{{route('product.PlusOneCart' , ['rowid'=> $row->rowId,'curcount'=>$row->qty])}}"
                                   class="btn btn-xs btn-success pull-right" role="button" style="margin-right: 3px">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="paymentTab">
                                        <form class="form-horizontal" method="post" action="#">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-4" for="delivery">Delivery
                                                    Method:</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <div class="addr_info" id="addr_info" style="display: none">
                                                    <label class="control-label col-sm-4" for="addr">Shipping
                                                        Address:</label>
                                    ...
                                    <div class="tab-pane" id="checkoutTab">
                                        ...
                                        <div class="row" style="margin-top: 15px">
                                            <label class="control-label col-sm-4" for="paymentMethod">Payment
                                                Method:</label>
                                            <div class="col-sm-6">
                                                <p id="pay_meth"></p>
                                            </div>
                                        ...
                                        <div class="row" id="addr_infoX" style="margin-top: 15px;display: none">
                                            <label class="control-label col-sm-4" for="paymentMethod">Delivery
                                                Address:</label>
                                            <div class="col-sm-6">
                                                <p id="line1x"></p>
                                                <p id="line2x"></p>
                                        ...
                                        <div class="row" style="margin-top: 15px">
                                            <div class="col-sm-offset-5 col-sm-2">
                                                <button type="button" id="orderSubmit" class="btn btn-success">Make
                                                    Order
                                                </button>
                                            </div>
                                        </div>
