        ...
        <div class="row">
            ...
            @if(count($errors)>0)   <!-- to show error alerts -->
                ...
                <form action="{{ route('user.signin') }}" method="post">
                    ...
                    <div style="margin-bottom: 3px"><button class="btn btn-lg btn-primary btn-block" type="submit" >Login</button></div>

                    <a href="{{route('user.signup')}}"><button class="btn btn-lg btn-primary btn-block" type="button">Signup</button></a>
                    {{ csrf_field() }}
                </form>
            </div>
        </div>
