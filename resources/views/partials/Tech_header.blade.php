<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('admin.index')}}">PC LIFE ONLINE | Technician</a>
        </div>

        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <button class="btn btn-danger navbar-btn">New Job</button>
                                <li class="{{ Request::is('/technician') ? 'active' : '' }}"><a href="{{route('technician.index')}}">Home <span
                                class="sr-only">(current)</span></a>
                </li>
                <li class="{{ Request::is('/technician') ? 'active' : '' }}"><a href="{{route('technician.Todo')}}">To Do List <span
                                class="sr-only">(current)</span></a>
                </li>
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true"
                       aria-expanded="false">To Do List <span class="caret"></span></a>
            ...
            <form class="navbar-form navbar-left">
                ...
                <button type="submit" class="btn btn-default">Search Job</button>
            </form>
