...
<div class="footer-section" style="box-shadow: 0px 0px 10px rgba(0,0,0,0.5); background-color: #5e5e5e">
    <div class="footer">
        <div class="container">
            <div class="col-md-4 footer-one">
                ...
                <p><b>PC-Life Solutions PVT LTD</b> Dealer for the world class best computer products and partner for
        ...
        <div class="row">
            <div class="col-sm-6 ">
                <div class="copyright-text">
                    <p>CopyRight © 2018 PC Life Solutions PVT LTD Digital All Rights Reserved</p>
                </div>
            </div> <!-- End Col -->
            <div class="col-sm-6  ">
                <div class="copyright-text pull-right">
                    <p><a href="#">Home</a> | <a href="#">Privacy</a> |<a href="#">Terms & Conditions</a> | <a href="#">Refund
                            Policy</a></p>
                </div>
