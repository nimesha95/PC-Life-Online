...
@section('content')
  ...
  background-image: linear-gradient(to bottom, #3498db, #2980b9); box-shadow: 0px 0px 2px #000; width: auto; padding: 10px">
    ...
    padding: 10px; background-color: rgba(255,255,255,0.5);">
            ...
            <div class="col-sm-2 dashcont" style="min-height: 500px; min-width: 200px"><h4>Tasks List</h4>
                <hr>
                ...
                @foreach($qarray as $Custom)
                    <form action="{{route('Addjobtask')}}" method="post">
                        ...
                        <button class="btn btn-lg btn-primary btn-block" type="submit"
                                style="margin-top: 2px">{{$Custom->Name}}</button>
                    </form>
            ...
            <div class="col-sm-4 dashcont" style="min-height: 500px; min-width: 450px; margin-left: 10px"><h4>Tasks For
                    Job</h4>
                <hr>
  ...
  background-image: linear-gradient(to bottom, #3498db, #2980b9); box-shadow: 0px 0px 2px #000; width: auto; padding: 10px">
    ...
    width:auto;
    padding: 10px;
    background-color: rgba(255,255,255,0.5) ;"><b>Total Opereational Time - <br>{{$DTOP}} Min</b></div>
                        <hr>
                        <div style="height:auto;
    width:auto;
    padding: 10px;
    background-color: rgba(255,255,255,0.5) ;"><b>Total Involvement Time - <br>{{$DINT}} Min</b></div>
                        <hr>
                        <div style="height:auto;
    width:auto;
    padding: 10px;
    background-color: rgba(255,255,255,0.5) ;"><b>Total Cost - <br>Rs.{{$cost}}</b></div>
                        <hr>
                        {{ csrf_field() }}
