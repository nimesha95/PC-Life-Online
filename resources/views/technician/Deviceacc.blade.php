    ...
    background-color: rgba(255,255,255,0.5) ;"><b>Enter Other Device Recieved</b></div>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default subbuttonred" data-toggle="modal">Confirm
                            </button>
                                    ...
                                    @if (($Custom->D1)!== '')
                                        ...
                                        @php ($i = $i+1)
                                            ...
                                            @if (($Custom->D2)!== '')
                                                <tr>
                                                    <td><label for="comment">{{$i}}</label></td>
                                                    <td><label for="comment" value="{{$Custom->D2}}">{{$Custom->D2}}
                                                    </td>
                                                            ...
                                                            @if (($Custom->D4)!== '')
                                                                ...
                                                                @php ($i = $i+1)
                                                                    ...
                                                                    @if (($Custom->D5)!== '')
                                                                        <tr>
                                                                            <td><label for="comment">{{$i}}</label></td>
                                                                            <td><label for="comment">{{$Custom->D5}}
                                                                            </td>
