    ...
    <div class="container">
        ...
        <div class="col-sm-12">
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-toggle="modal" data-target="#newtask" role="dialog">
                    Add New Task
                </button>
                                            ...
                                            <form action="{{route('customizetask')}}" method="post">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" Name="DOPT"
                                                               pattern="\d*" value="{{$Tasks->DOPT}}">
                                                        <label for="comment"> Default Involve Time :</label>
                                                        <input type="text" class="form-control" Name="DINT"
                                                               pattern="\d*" value="{{$Tasks->DINT}}">
                                                        <label for="comment"> Default Price :</label>
                                                        <input type="text" class="form-control" Name="price"
                                                               pattern="\d*" value="{{$Tasks->price}}">
                                                        ...
                                                        <div class="row">
                                                            <div class="btn-group" data-toggle="buttons"
                                                                ...
                                                                <label class="btn btn-primary">
                                                                    <input type="radio" name="Select" value="L"
                                                                           @if (($Tasks->used) === 'L')
                                                                           checked="checked"
                                                                            @endif> Laptop
                                                                </label>
                        ...
                        <form action="{{route('addnewtask')}}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <label for="comment"> Default Price :</label>
                                    <input type="text" class="form-control" Name="price" value="" pattern="\d*"
                                           required>
