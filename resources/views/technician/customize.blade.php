                        ...
                        <div class="col-md-6">
                            ...
                            <table border="0" class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D10" value="{{$Custom->D10}}">
                                    </td>
                        ...
                        <div class="col-md-6">
                            ...
                            <table border="0" class="table table-hover">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D11" value="{{$Custom->D11}}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D12" value="{{$Custom->D12}}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D13" value="{{$Custom->D13}}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D14" value="{{$Custom->D14}}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D15" value="{{$Custom->D15}}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D16" value="{{$Custom->D16}}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D17" value="{{$Custom->D17}}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D18" value="{{$Custom->D18}}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D19" value="{{$Custom->D19}}">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" Name="D20" value="{{$Custom->D20}}">
                                    </td>
