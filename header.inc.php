    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mainNavBar">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Desktop Computers <span
                                class="caret"></span></a>
                    <ul class="dropdown-menu multi-column columns-2">
                        <div class="row">
                            <div class="col-sm-6">
                                <ul class="multi-column-dropdown">
                                    <li><a href="items.html.php?item=tb_desktop&cat=Used"><b>Used Computers</b></a></li>
                                    <li><a href="items.html.php?item=tb_desktop&cat=Used">HP</a></li>
                            ...
                            <div class="col-sm-6">
                                <ul class="multi-column-dropdown">
                                    <li><a href="items.html.php?item=tb_desktop&cat=Brand_New"><b>Brand New
                                                Computers</b></a></li>
                                    <li><a href="#">HP</a></li>
                                    <li><a href="#">Samsung</a></li>
                                    <li><a href="#">Lenovo</a></li>
                ...
                <li>
                    <div class="search-box">
                        <form action="search.php" method="post">
                            <input name="my_html_input_tag" type="text" class="form-control" autocomplete="off" placeholder="Search item"/>
